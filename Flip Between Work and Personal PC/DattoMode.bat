...
C:\etc\Programs\Installers\ControlMyMoniotr/ControlMyMonitor.exe /SetValue "97PN4W2" 60 17
...
::C:\etc\Programs\Installers\ControlMyMoniotr/ControlMyMonitor.exe /SetValue "VVJ203801749" 60 15

::Set Righty to DATTO Mode
C:\etc\Programs\Installers\ControlMyMoniotr/ControlMyMonitor.exe /SetValue "VVJ204000006" 60 15